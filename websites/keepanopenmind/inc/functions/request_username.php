...
if ($db_found) {
$SQL = "INSERT INTO `username` (`username`, `password`, `username2`) VALUES ('$username', '$password', '$username2')";
...
Changing your username when working at <b>KeepAnOpenMind</b> is a little bit more difficult than usual, not by choice; we do this simply because we cannot take chances with people and their usernames.<br/><br/>We have created a form for you to use, all you have to do is fill it in and one of the management team will be sure to change your username for you if you supply the correct password (this will be checked).<br/><br/><br/>
<center>
