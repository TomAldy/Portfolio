...
<tr>
<td align="center" valign="middle" background="../images/layout/content/title_bar.png" width="613" height="25" style="background-repeat:no-repeat;;background-position:center center"><font style="font-size:10px" color="#FFFFFF" face="Verdana"><b>Movie News</b></font></td>
</tr></table><br><br />
<br />
<img src="../images/newspaper.gif" align="right" />
<b>The Movie News!</b><br />
<i>Which one is the best?</i><br />
<br />
This page holds all of the news related to new movies, everything brand new and up to date that you would like to know is open and available to you from our news team, they like to make sure that everything is kept up to date, and any news that is not reported that you think should be can be added quite simply, just use the contact us form under the 'KAOM' section on the websites main menu, contacting us only takes a couple of minutes and lets us known that we need to start being more on top of things when it comes to our news group.<br/><br/><br/>
<?php
include("../inc/functions/config.php");
$r = mysql_query("SELECT * FROM `news` WHERE `category` = 'Movie' ORDER BY id Desc ");
