...
$r = mysql_query("SELECT * FROM `username`");
...
<tr>
<td align="center" valign="middle" width="49" height="54" bgcolor="#D8D8D8"><a href="delete_username.php?id=<?php echo $id ?>"><img src="../../images/staff/delete.png" border="0"></a></td>
<td align="left" valign="middle" width="278" height="54" bgcolor="#D8D8D8" style="padding-left: 6px;"><b>Username:</b> <?php echo $username ?><br/><b>Current Password:</b> <?php echo $password ?><br/><b>Username Change:</b> <?php echo $username2 ?><br/><i>You must be confident that you know if the person is who they say they are.</i></td>
</tr>
</table>
<br/>
</center>
